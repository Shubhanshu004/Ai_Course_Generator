...
const getAllSession = async(req , res) => {
    ...
    const result = await pool.query('select id , parent_session_id , summary , status , created_at from sessions where course_id = $1 order by created_at asc', [id])
...
module.exports = {sessionSummary , getAllSession }
